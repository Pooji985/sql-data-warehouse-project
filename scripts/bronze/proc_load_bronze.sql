...
Purpose:
    ...
    Existing data is truncated and reloaded to ensure consistency.

Highlights:
    - BULK INSERT is used for fast data ingestion.
    - XACT_ABORT is enabled to stop and roll back the load on any failure.
    - ROWTERMINATOR is defined to correctly read CSV row boundaries.
    - Execution time is logged for basic monitoring.
